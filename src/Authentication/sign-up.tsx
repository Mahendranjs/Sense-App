...
import { Keyboard, Platform, TouchableWithoutFeedback, TouchableOpacity } from "react-native";
...
const SignUpScreen = (props: any) => {
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <KeyboardAvoidingView backgroundColor="#ffffff"
                    ...
                    <HStack px={6} position="absolute" bottom={2} space={5} >
                        <Button rounded="lg" fontSize="lg" fontWeight="800" size="md" _text={{ fontWeight: "semibold" }} variant="outline" borderColor="primary.500" flexGrow={1} onPress={() => props.navigation.navigate('Login')}>Back To Login</Button>
    ...
    const Tab3 = () => {
        function onNext() {
            props.navigation.navigate('Pilot')
        }
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <KeyboardAvoidingView backgroundColor="#ffffff"
                    ...
                    <HStack px={6} position="absolute" bottom={2} space={5} >
                        ...
                        <Button rounded="lg" size="md"  _text={{ fontWeight: "semibold" }} flexGrow={1} onPress={() => onNext()}>Continue</Button>
                    </HStack>
                </KeyboardAvoidingView>
            </TouchableWithoutFeedback>
        );
