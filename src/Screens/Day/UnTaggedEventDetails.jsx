...
export default function UnTaggedEventDetailScreen(props) {
    ...
    const data1 = [
        ...
        { startTime: new Date(2018, 0, 0, 7, 18).getTime(), endTime: new Date(2018, 0, 0, 23, 7).getTime(), color: 'rgba(253, 181, 175, 0.2)', startDateTime: new Date(2018, 0, 0, 7, 18), endDateTime: new Date(2018, 0, 0, 23, 7) },
    ];
    ...
    const HeartBeatData = [80,83,82,84,81,83,86,84,88,85,89,87,90,95,92,96,93,97,94,97,95,98,94,99,96,102,99,104,100,105,102,106,104,108,105,109,112,100,106,103,100,114,111,109,110,107,109,106,107,103,105,101,102,98,100,96,98,95,97,93,94,90];
        ...
        <>
                ...
                <HStack mt={2}>
                    ...
                    <VStack mt={2} mr={1}>
                        <Circle size="30px" bg="#fdb5af">
                            <Octicons color="#FF3C3C" name="upload" size={18}></Octicons>
                        </Circle>
                    </VStack>
                    <VStack mt={1}>
            ...
            <ScrollView backgroundColor="#fff" showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
                ...
                <View h="100%" w="100%" px={3} style={{ backgroundColor: "#ffffff" }}>
                    ...
                    <Heading color="black" fontSize="sm" mt={6} mb={4}>Activity Details</Heading>
                    <Box borderColor="coolGray.200" borderWidth="1" mb={4}>
                        ...
                        <Text color="#FFAC1C" fontSize="sm" px={3} mt={2}>Avg. Heart Rate</Text>
                    ...
                    <Box mb={4} borderColor="coolGray.200" borderWidth="1">
                        <VStack>
                            <View w="100%" px={2} mb={2} flexDirection="row">
                                <View w="50%">
                                    <Text color="black" bold textAlign="left" fontSize="xs">Duration</Text>
                                </View>
                                <View w="50%">
                            ...
                            <Progress size="xs" mb={4} _filledTrack={{
                                bg: "#FFAC1C"
                            }} backgroundColor="gray.100" value={45} />
                        </VStack>
                    </Box>
